...
// This is the base class for rocket tests, it will create some sample geometry
class SceneLoader : public Test
{
public:
	JPH_DECLARE_RTTI_VIRTUAL(JPH_NO_EXPORT, SceneLoader)
